...
export enum RequestStatus {
  ...
  VP_RESEARCH_APPROVAL = 'vp_research_approval',
  VP_ACADEMIC_APPROVAL = 'vp_academic_approval',
  VP_ADMIN_APPROVAL = 'vp_admin_approval',
  RESEARCH_DIRECTOR_APPROVAL = 'research_director_approval',
