...
export function canApproveRequest(userRole: UserRole, requestStatus: string): boolean {
  const approvalMatrix: Record<string, UserRole[]> = {
    ...
    'vp_approval': [UserRole.VP_RESEARCH, UserRole.VP_ACADEMIC, UserRole.VP_ADMIN],
    'vp_research_approval': [UserRole.VP_RESEARCH],
    'vp_academic_approval': [UserRole.VP_ACADEMIC],
    'vp_admin_approval': [UserRole.VP_ADMIN],
    'research_director_approval': [UserRole.RESEARCH_DIRECTOR],
